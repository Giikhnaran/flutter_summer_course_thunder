          ...
          child: Column(
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  children: [
                    Row(mainAxisAlignment: MainAxisAlignment.center, children: [GradientLetter('W'),GradientLetter('O'), GradientLetter('R'), GradientLetter('D')],),
              ...
              Expanded(child: Image.asset('assets/images/iCodeGuy.png')),
